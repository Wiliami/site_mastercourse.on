...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? module.exports = factory(require('@popperjs/core'), require('./dom/selector-engine.js'), require('./dom/data.js'), require('./dom/event-handler.js'), require('./dom/manipulator.js'), require('./base-component.js'))
    : (typeof define === 'function' && define.amd
      ? define(['@popperjs/core', './dom/selector-engine', './dom/data', './dom/event-handler', './dom/manipulator', './base-component'], factory)
      : (global = typeof globalThis === 'undefined' ? global || self : globalThis, global.Tooltip = factory(global.Popper, global.SelectorEngine, global.Data, global.EventHandler, global.Manipulator, global.Base)))
})(this, ((Popper, SelectorEngine, Data, EventHandler, Manipulator, BaseComponent) => {
  'use strict'
  ...
  class Tooltip extends BaseComponent__default.default {
    ...
    hide() {
      ...
      if ('ontouchstart' in document.documentElement) {
        document.body.children.flat().forEach(element => EventHandler__default.default.off(element, 'mouseover', noop))
      }
